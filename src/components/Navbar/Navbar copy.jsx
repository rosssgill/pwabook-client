  ...
  return (
    <AppBar position="static" color="inherit">
      <div>
        ...
        <img src={logo} alt="PWABook" height="60" />
      </div>
      ...
      <Toolbar>
        {user ? (
          <div>
            ...
            <Button variant="contained" colour="secondary" onClick={logout}>
              Logout
            </Button>
          </div>
        ) : (
          <Button component={Link} to="/auth" variant="contained" colour="primary">
            Log In
          </Button>
        )}
      </Toolbar>
